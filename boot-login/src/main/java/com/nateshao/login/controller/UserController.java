package com.nateshao.login.controller;

import com.nateshao.login.common.ApiResponse;
import com.nateshao.login.common.DataType;
import com.nateshao.login.common.ParamType;
import com.nateshao.login.domain.User;
...
@RestController
@RequestMapping("/user")
@Api(tags = "UserController", description = "用户管理", value = "用户管理")
@Slf4j
